...
public class ProductService {
	...
	public productListDate productListDessertDate(int reqPage) {
		...
		List list = productDao.ProductListDessert(param);
	...
	public List allProductList(String pageNavi, int reqPage) {
		int numPerPage =6;
		int end = reqPage*numPerPage;
		int start = end-numPerPage+1;
		HashMap<String,Object> param = new HashMap<String, Object>();
		...
		List allProductList = productDao.allproductList(param);
